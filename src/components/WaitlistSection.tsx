      ...
      <div className="max-w-4xl mx-auto">
        {!isJoined ? (
          <div className="text-center space-y-12">
            <div className="space-y-4">
               <h2 className="text-4xl md:text-5xl font-serif text-gold-leaf">Secure Your Signature</h2>
            ...
            <div className="glass rounded-3xl p-8 relative overflow-hidden border-gold/20">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="space-y-1">
                    <div className="text-6xl font-serif text-white tracking-tighter">#<AnimatedCounter value={position} /></div>
        ...
        >
            {[
                ...
                { label: 'General Waitlist', status: isJoined ? 'achieved' : 'potential', icon: CheckCircle2, desc: isJoined ? 'Standard Access' : 'Join to Unlock' }
            ].map((tier) => (
                <motion.div 
                    key={tier.label}
                    variants={{
